...
def learn(env, policy_func, *,
    ...
    if (flag_load > 0):
        print('Loading!')
        time.sleep(3)
        data_path = '/home/icenter/tmp/openai_data/para_%i_%i/' % (flag_load // 100, flag_load // 10)
    ...
    while True:
        ...
        if (iters_so_far % 10 == 0):
            data_path = '/home/icenter/tmp/openai_data/para_%i_%i/' % (iters_so_far // 100, iters_so_far // 10)
